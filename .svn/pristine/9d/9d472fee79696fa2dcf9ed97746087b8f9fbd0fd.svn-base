 ...
 * 
 */
@RouteBind(path = "Main/PartyMeeting", viewPath = "Work/Meeting/PartyMeeting")
public class PartyMeeting extends BaseAssociationController {
    String menuId = "PartyMeeting";
