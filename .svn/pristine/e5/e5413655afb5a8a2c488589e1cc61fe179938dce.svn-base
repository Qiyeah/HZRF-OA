...
<div class="bjui-pageContent">
     <form id="pageForm" class="pageForm" action="Main/Mail/save" method="post" data-toggle="validate">   
        <input name="t_Mail.id" type="hidden" value="${model.id}"/>
            ...
            <table class="wordInfo" align="center" style="width: 99%;">
                <tr class="nowrap">
                    ...
                    <td style="width: 85%;">
                    	...
                    	<input type="text" readonly="readonly" name="param.userName" size="82" value="${model.receiver}" class="required"  data-rule="required" data-msg-required="必填"
                ...
                <tr class="nowrap">
                    ...
                    <td >
                       ...
                       <input type="text" readonly="readonly" name="param2.userName" size="82" data-group="param2" value="${model.copyer}" data-title="选择抄送人" data-toggle="lookup"
