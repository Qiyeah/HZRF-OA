...
<div class="bjui-pageHeader">
	<form method="post" id="pagerForm" action="Main/Docreceive/todolist" data-toggle="ajaxsearch">
		...
		<div class="bjui-searchBar">
			...
			<div class="pull-right" >
				<a href="Main/Docreceive/toapprove/{#bjui-selected}" class="btn btn-blue" data-toggle="dialog" data-mask="ture" data-id="approve_dialog1" data-icon="fa-edit" data-title="编辑 /审批 " data-width="850" data-height="600">编辑 /审批</a> 
				...
				<c:when test="${! empty page.list}">
					<c:forEach items="${page.list}" var="wf" varStatus="vs">
						<c:set value="${fn:split(wf.todoman,';')}" var="uids" />
							<tr  style="cursor:pointer" title="双击打开" align="center" data-id="${wf.id}" dbDialog="true" dbTitle="编辑" dbDialogId="approve_dialog1" maxable="true" mask="true" dbWidth="850" dbHeight="600"
