	...
	<form id="approveForm" action="Main/Docsend/save1" method="post" data-toggle="validate">
		<div class="pageFormContent">
		  <input type="hidden" name="DocumentID" value="${dc.pid}">
			...
			<input type="hidden" name="sendDept1.send1" value="${dc.send1}" />
			<input type="hidden" name="sendDept2.send2" value="${dc.send2}" />
			<input type="hidden" name="jbr.username" value="${dc.proof}" />
			<input type="hidden" name="t_Doc_Send.num" value="${dc.num}" />
