...
_loader.use("jquery", function () {
    ...
    var e = $("#mohe-rili"), t = $(".mh-rili-wap", e), n = $(".mh-tips", e), r = $(".mh-rili-foot", e), i = "0", s = "#mohe-rili .mh-rili-widget", o = e.find(".mh-holiday-data"), u = "", a = !1, f = e.find("#mh-date-y").html();
    h(), e.on("click", ".mh-op a", function (e) {
        ...
        var e = $(this), t = e.val(), n = e.find("option:selected"), i = n.attr("data-desc") || "", s = n.attr("data-gl") || "";
        if (!a || t == "0" || i === "" && s === "")r.html(""); else {
...
_loader.use("jquery, rili-widget", function () {
    ...
    // RiLi.AppData(namespace, signature, storeObj) 为了解决"In IE7, keys may not
