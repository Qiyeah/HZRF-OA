...
<c:set var="page" value="${page}"/>
	...
	<form id="pagerForm" action="Main/Mail/rubbish" method="post" data-toggle="ajaxsearch">
	...
	<div class="pull-right">
        <a href="Main/Mail/delete/1-rubbish" class="btn btn-red" data-toggle="doajaxchecked" data-group="ids" data-icon="fa-trash-o" data-confirm-msg="彻底删除后邮件将无法恢复，您确定要删除吗？">彻底删除</a>  
	 	
	 	<a href="Main/Mail/recover" class="btn btn-blue" data-toggle="doajaxchecked" data-group="ids" data-icon="fa-check" data-confirm-msg="您确定要恢复吗？">恢复</a>
...
<div class="tableContent">
	<table class="table table-bordered table-hover table-striped table-top table-center" data-nowrap="true" data-toggle="tablefixed" data-selected="true">
		<thead>
			<tr align="center">
				<th align="center" width="5%"><input type="checkbox" class="checkboxCtrl" data-group="ids" data-toggle="icheck"></th>
