...
<div class="bjui-pageHeader">
	 <form id="pagerForm" action="Main/Docsend/todolist" method="post" data-toggle="ajaxsearch">
		...
		<div class="bjui-searchBar">
			...
			<button type="button" class="btn btn-green" data-url="Main/Docsend/apply" data-toggle="dialog" data-icon="plus" data-mask="true" data-id="approve_dialog" data-title="公文拟稿"
					data-width="850" data-height="600">公文拟稿</button>
			<a href="Main/Docsend/toapprove/{#bjui-selected}" class="btn btn-blue" data-toggle="dialog" data-icon="edit" data-mask="ture" data-id="approve_dialog" data-title="编辑 /审批"
            ...
            <c:choose>
                <c:when test="${! empty page.list}">
                    <c:forEach items="${page.list}" var="wf" varStatus="vs">
                        ...
                        <tr style="cursor:pointer" title="双击打开" align="center" target="id" data-id="${wf.id}" dbDialog="true" dbDialogId="approve_dialog" max="false" mask="true" maxable="false" minable="false" resizable="false" drawable="false" dbTitle="编辑 /审批" dbWidth="850" dbHeight="600" href="Main/Docsend/toapprove/${wf.id}">
                            <td>${vs.index+1}</td>
