	...
	<form method="post" id="pagerForm" action="Main/Relation/AnalyzeMap" onsubmit="return validateCallback(this,dialogAjaxDone);">
		<div class="searchBar">
			<input type="hidden" name="pageNum" value="${page.pageNumber}" /> <input type="hidden" name="numPerPage" value="${page.pageSize}" />
					<label>统计类别：</label>
					<select id="tjtotype" name="t_Relation.totype" class="combox">
					...
					<label>转接类型</label>
					 ...
					 <label>落实情况：</label><select id="result" name="t_Relation.result" class="combox">
							<option value="0">--所有--</option>
							<option value="1">未落实</option>
							<option value="2">已落实</option>
					</select>
					 <label>党员类型：</label><select id="type" name="t_Relation.type" class="combox">
                     	<option value="0">--所有--</option>
                        <option value="1">预备</option>
                        <option value="2">正式</option></select><br>
                        
					 <label>办理时间：</label><input type="text" id="sdate" name="sdate" style="width: 120px;margin-top:6px" data-rule="date" data-toggle="datepicker" readonly value="${sdate}"> - <input type="text" id="edate" name="edate"
						style="width: 120px;margin-top:6px" data-rule="date" data-toggle="datepicker" readonly value="${edate}">
						<button type="button" id="btngo" style="margin-top:6px" class="btn-default" data-icon="search">查询</button>
				 <!-- <tr>
...
<script src="<%=basePath%>styles/echarts/build/dist/echarts-all.js"></script>
  ...
  <div class="bjui-pageContent" style="vertical-align:middle" layoutH="10"> 
