...
<div class="bjui-pageContent">
    <form method="post" action="Main/Department/update" class="pageForm" data-toggle="validate">
        <input type="hidden" name="t_Department.id" value="${model.id}">
        <input type="hidden" name="t_Department.pid" value="${model.pid}"/>
        <input type="hidden" name="t_Department.dlvl" value="${model.dlvl }"/>
        <input type="hidden" name="t_Department.area" id="area" value="${model.area }"/>
        <table class="table table-condensed table-hover">
            <tr>
                <td>
                    <label class="control-label x85">部门全称：</label>
                    <input type="text" name="t_Department.fname" value="${model.fname}" maxlength="50" size="30" data-rule="required">
                </td>
            </tr>
            <tr>
                <td>
                    <label class="control-label x85">部门简称：</label>
                    <input type="text" name="t_Department.sname" value="${model.sname}" maxlength="20" size="30" data-rule="required">
                </td>
            </tr>
			<tr>
			...
			<tr>
				<td><label class="control-label x85">部门排序：</label>
					<input type="text" name="t_Department.no" value="${model.no }" maxlength="20" size="20" data-rule="digits" /></td>
			</tr>
            <tr>
                <td>
