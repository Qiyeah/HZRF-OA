...
<dl class="nowrap">
		<dd>
			<div data-toggle="upload" data-uploader="Main/Attachment/saveAttachment" data-icon="cloud-upload" data-multi="true" data-auto="true" data-button-text="Excel文件上传" data-on-upload-success="doc_upload_success"
				data-file-Obj-Name="enclosure" data-file-type-exts="**.xlsx;"></div>
		</dd>
	</dl>
	<div id="fileList"></div>