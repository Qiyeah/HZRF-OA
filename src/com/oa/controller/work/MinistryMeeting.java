 ...
 * 
 */
@RouteBind(path = "Main/MinistryMeeting", viewPath = "Work/Meeting/MinistryMeeting")
public class MinistryMeeting extends BaseAssociationController {
    String menuId = "MinistryMeeting";
