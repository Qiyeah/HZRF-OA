...
<div class="bjui-pageHeader">
 <form id="pagerForm" action="Main/Leave/noendlist" method="post" data-toggle="ajaxsearch">
    <div class="bjui-searchBar">
        ...
        <input type="hidden" name="orderField" value="${orderField}" />  
           ...
           <label>申请日期：</label><input type="text" name="sdate" style="width: 120px" data-toggle="datepicker" readonly value="${sdate}"> - <input type="text" name="edate" style="width: 120px" data-toggle="datepicker" readonly value="${edate}"></td>
        	...
        	<a href="Main/Leave/delete/{#bjui-selected}" class="btn btn-red" data-toggle="doajax" data-icon="fa-trash-o" data-confirm-msg="您确定要删除该记录吗?">删除</a>
            ...
            <c:choose>
                <c:when test="${! empty page.list}">
                    <c:forEach items="${page.list}" var="wf" varStatus="vs">
                        ...
                        <tr  style="cursor:pointer" title="双击打开" align="center" target="id" data-id="${wf.id}" dbDialog="true" dbTitle="查看 " dbDialogId="approve_print" max="false" mask="true" maxable="false" minable="false" resizable="false" drawable="false"  dbWidth="850" dbHeight="600" href="Main/Leave/print/${wf.id}">
                            <td>${vs.index+1}</td>
