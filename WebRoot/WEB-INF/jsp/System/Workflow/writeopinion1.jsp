...
<script type="text/javascript">
	...
	function sendback() {
		var pfield = $("#opinionfield").val();
		var popinion = $("#opinion");
		var ptime = $("#opiniontime");
		var timer = new Date();
		...
		$("#" + pfield+"_1").html(
		$("#" + pfield).val() + "&nbsp;&nbsp;" + $("#writeopinion").val() +  "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + $("#curuser1").val() + "&nbsp;&nbsp;[" + optime + "]<br>");
...
<div class="bjui-pageContent">
	<form method="post" action="" class="pageForm" data-toggle="validate">
		...
		<tr>
			<td width="15%">常用意见：</td>
			<td width="85%">
				<select id="usedopinion" data-toggle="selectpicker" onchange="selectopinion()" data-width="90%">					
