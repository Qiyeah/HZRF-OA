...
<div class="bjui-pageContent">
	<form method="post" action="Main/Field/add" class="pageForm" data-toggle="validate">
		<table class="table table-condensed table-hover">
			...
			<tr>
				...
				<input type="text" name="t_Field.name" id="j_name" maxlength="30" size="20" data-rule="required"></td>
			</tr>
			<tr>
				<td><label for="j_keyword" class="control-label x85">替换字符：</label>
				<input type="text" name="t_Field.keyword" id="j_keyword" maxlength="30" size="20"></td>
			</tr>
			<tr>
				...
				<select name="t_Field.type" id="j_type" data-toggle="selectpicker" aria-required="true" class="show-tick" style="display: none;">
					<option value="1" selected>多次</option>
			...
			<tr>
				<td>
                    ...
                    <input type="radio" name="t_Field.calculation" value="0"
                           <c:if test="${empty model.calculation || commission.calculation==0}">checked</c:if> data-toggle="icheck" data-label="否"/>
                </td>
			</tr>
		</table>
	</form>
