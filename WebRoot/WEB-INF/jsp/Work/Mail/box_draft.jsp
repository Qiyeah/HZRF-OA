...
<div class="bjui-pageHeader">
	<form id="pagerForm" action="Main/Mail/draft" method="post" data-toggle="ajaxsearch">
    ...
    <div class="pull-right">
	   <a href="Main/Mail/delete/1-draft" class="btn btn-red" data-toggle="doajaxchecked" data-group="ids" data-icon="fa-trash-o" data-confirm-msg="删除后草稿将无法恢复，您确定要删除吗？?">删除</a>
                   
       <a href="Main/Mail/edit/{#bjui-selected}" class="btn btn-blue" data-toggle="dialog" data-icon="fa-edit" data-mask="ture" data-id="Mailview" data-title="修改"
					data-width="1000" data-height="600">编辑</a>
           
        <a href="Main/Mail/delete/1-draft" class="btn btn-red" data-toggle="doajaxchecked" data-group="ids" data-icon="fa-trash-o" data-confirm-msg="彻底删除后邮件将无法恢复，您确定要删除吗？">彻底删除</a>  
	</div>
   <br>
...
<div class="tableContent">
	<table class="table table-bordered table-hover table-striped table-top table-center" data-nowrap="true" data-toggle="tablefixed" data-selected="true">
		...
		<c:choose>
			...
			<tr style="cursor:pointer" title="双击打开" target="id" data-id="${list.id}"  dbDialog="true" dbTitle="编辑" dbDialogId="editMail" maxable="true"
                mask="true" dbWidth="1000" dbHeight="600" href="Main/Mail/edit/${list.id}">
