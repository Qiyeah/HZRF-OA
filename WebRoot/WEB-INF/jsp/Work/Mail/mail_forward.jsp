...
<div class="bjui-pageContent">
    <form id="pageForm" class="pageForm" action="Main/Mail/save" method="post" data-toggle="validate">
        <input name="t_Mail.id" type="hidden" value=""/>
        ...
        <input name="originalMailStatus" type="hidden" value="${model.status}"/>
            ...
            <table class="wordInfo" align="center" style="width: 99%;">
                <tr class="nowrap">
                    ...
                    <td style="width: 85%;">
                        <input name="param.userId" type="hidden" value="${model.receiverId}"/>
                        <input type="text" readonly="readonly" name="param.userName" size="82" value="" class="required"  data-rule="required" data-msg-required="必填"
                ...
                <tr class="nowrap">
                    ...
                    <td style="width: 85%;">
                        <input name="param2.userId" type="hidden" value="${model.copyerId}"/>
                ...
                <tr class="nowrap">
                    ...
                    <td>
                        <input name="t_Mail.title" type="text" style="width: 100%;" class="required" value="${model.title}"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    emoticons">------------------ 原始邮件 ------------------<br/>发件人: ${fromUser};<br/>发送时间:${fn:substring(model.sendTime, 0, 19)}<br/>收件人: ${model.receiver};<br/><c:if test="${!empty model.copyer}">抄送: ${model.copyer}<br/></c:if>${model.content}</textarea>
                    </td>
                </tr>
            </table>
    </form>
