		...
		<div class="pageFormContent" layoutH="59">
			...
			<table class="wordInfo" align="center" style="width: 95%;margin-bottom:23px">
				...
				<tr>
					...
					<td><input type="text" data-toggle="datepicker" name="t_Meeting_Approve.approvedate" value="${mt.approvedate }" class="required date" style="width: 100%" /></td>
                    <td class="title">会议时间</td>
                    <td>
                        <table style="width: 100%">
                            <tr>
                                <td style="border: 0px;width:85px" >
                                    <input type="text" data-toggle="datepicker" name="t_Meeting_Approve.mdate" class="required" data-rule="required"  style="width: 100%" value="${mt.mdate}"/>
                                </td>
                                <td style="border: 0px;width:20px">日</td>
                                <td style="border: 0px;width:20px"> <select name="t_Meeting_Approve.hour" data-toggle="selectpicker">
                                ...
                                <td style="border: 0px;width:20px"><select name="t_Meeting_Approve.minute" data-toggle="selectpicker">
				...
				<tr>
					...
					<td><input type="hidden" name="chairman.userid" value="${mt.chairman }" />					
						<input type="text" name="chairman.username" value="${chairman }" suggestFields="username" suggestUrl="Main/search/searchUser" lookupGroup="chairman" 
						style="width:100%" class="required" data-rule="required"/></td>
				...
				<tr>
					...
					<td colspan="3"><input type="hidden" name="attendee.id" value="${mt.attendee }" />
						<input type="text" name="attendee.name" value="${attendee }" readonly="readonly" style="padding-right: 0px;width:100%;"
						 href="Main/search/searchUsers" lookupGroup="attendee" rel="searchUser" data-width="500" data-height="480" data-title="出席人"></td>
				</tr>
				<tr>
