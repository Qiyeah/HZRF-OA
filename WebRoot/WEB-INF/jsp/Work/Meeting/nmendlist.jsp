...
<form method="post" id="pagerForm" action="Main/Meeting/nmendlist" onsubmit="return navTabSearch(this);">
		...
		<div class="searchBar">
			<table id="todoSearch" class="searchContent">
				<tr>
					...
					<td><span>申请日期：</span></td><td><input type="text" name="sdate" style="width: 100px" class="date" readonly value="${sdate}"> - <input type="text" name="edate" style="width: 100px" class="date" readonly value="${edate}"></td>
					<td>
						<div class="subBar">
					...
					<c:when test="${! empty page.list}">
						<c:forEach items="${page.list}" var="wf" varStatus="vs">
							<tr style="cursor:hand" align="center">
								...
								<td></td>
								<td><a class="btnView" href="Main/Meeting/detail/${wf.id}" target="dialog" mask="true" drawable="true" resizable="true" rel="approveDialog" width="850" height="600"
									title="查看"></a></td>
							</tr>
						</c:forEach>
					</c:when>
