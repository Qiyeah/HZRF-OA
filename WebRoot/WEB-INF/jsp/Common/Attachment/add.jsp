...
<dl class="nowrap">
		<dd>
			<div data-toggle="upload" data-uploader="Main/Attachment/saveAttachment" data-icon="cloud-upload" style="margin-top:0px" data-multi="true" data-auto="true"  data-button-text="附件上传" data-on-upload-success="doc_upload_success"
				data-file-Obj-Name="enclosure" data-file-type-exts="*.pdf;*.img;*.exe;*.xlsx;*.xls;*.jpg;*.docx;*.doc;*.png;*.bmp,*.png,*.tiff,*.gif"></div>
		</dd>
	</dl>
	<div id="fileList"></div>