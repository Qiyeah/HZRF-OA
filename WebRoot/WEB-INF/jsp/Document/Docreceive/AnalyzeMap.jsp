...
<div class="bjui-pageHeader">
    <div class="bjui-searchBar">
        <form id="pagerForm" action="Main/Docreceive/AnalyzeMap" method="post" data-toggle="ajaxsearch">
            ...
            <td><span>统计类别：</span></td>
            	<td>
            		<select id="type" name="type" data-toggle="selectpicker">
					    ...
					    <option value="b_02" >来文单位类别</option>
					    <!-- <option value="l_01" >收发文按日别统计</option>-->
					    <option value="l_02" >收文月份别统计</option>
					</select>
            	</td>
				<td><span>收文时间：</span></td><td><input type="text" id="sdate" name="sdate" style = "width:120px" data-toggle="datepicker" readonly value="${sdate}"> - <input type="text" id="edate" name="edate" style = "width:120px" data-toggle="datepicker" readonly value="${edate}"></td>
                <td>
        ...
        $("#btngo").click(function () {
            ...
            case "z":
                ...
                $.ajax({
                    type: "post",
                    async: false, //同步执行
                    url: "Main/Docreceive/AnalyzeMapGetData",
